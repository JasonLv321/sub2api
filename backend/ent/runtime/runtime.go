...
func init() {
	...
	// usagelogDescDepartmentCode is the schema descriptor for department_code field.
	usagelogDescDepartmentCode := usagelogFields[6].Descriptor()
	// usagelog.DefaultDepartmentCode holds the default value on creation for the department_code field.
	usagelog.DefaultDepartmentCode = usagelogDescDepartmentCode.Default.(string)
	// usagelog.DepartmentCodeValidator is a validator for the "department_code" field. It is called by the builders before save.
	usagelog.DepartmentCodeValidator = usagelogDescDepartmentCode.Validators[0].(func(string) error)
