...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "department_code", Type: field.TypeString, Size: 100, Default: "unknown"},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_created_at_department_code_requested_model",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[41], UsageLogsColumns[4], UsageLogsColumns[3]},
			},
		},
	}
